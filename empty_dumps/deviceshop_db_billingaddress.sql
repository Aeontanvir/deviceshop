...
CREATE TABLE `billingaddress` (
  ...
  KEY `FKF0492D19FF6D087E` (`customer_cutomerId`),
  CONSTRAINT `FKF0492D19FF6D087E` FOREIGN KEY (`customer_cutomerId`) REFERENCES `customer` (`cutomerId`)
...
INSERT INTO `billingaddress` VALUES (1,'420','Dhaka','Bangladesh','Dhaka','6/D','1216',1),(2,'420','Azimpur','Bangladesh','Dhaka','6/D','1878',2);
